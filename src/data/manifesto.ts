...
export const authorProfile: AuthorProfile = {
  ...
  phone: '+593 96 996 2799',
  whatsapp: '593969962799',
...
export const skillsData: SkillGroup[] = [
  ...
  },
  {
    ...
    skills: [
      { name: 'Comunicación Asertiva y con Clientes',  sfiaLevel: 5, sfiaLabel: 'SFIA L5 · ENSURE / LEAD' },
      { name: 'Trabajo en Equipo y Colaboración',      sfiaLevel: 5, sfiaLabel: 'SFIA L5 · ENSURE / LEAD' },
      { name: 'Resolución de Problemas y Pragmatismo', sfiaLevel: 5, sfiaLabel: 'SFIA L5 · ENSURE / LEAD' },
      { name: 'Adaptabilidad y Aprendizaje Continuo',  sfiaLevel: 5, sfiaLabel: 'SFIA L5 · ENSURE / LEAD' },
      { name: 'Autonomía y Responsabilidad (Ownership)', sfiaLevel: 5, sfiaLabel: 'SFIA L5 · ENSURE / LEAD' },
      { name: 'Empatía y Orientación al Usuario Final', sfiaLevel: 4, sfiaLabel: 'SFIA L4 · ENABLE'        },
    ],
  },
];
